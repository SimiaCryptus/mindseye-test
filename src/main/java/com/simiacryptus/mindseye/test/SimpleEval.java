...
public @RefAware
class SimpleEval extends ReferenceCountingBase implements Callable<SimpleEval> {
  @Nonnull
  ...
  public static SimpleEval run(@Nonnull final Layer layer, final Tensor... tensor) {
    SimpleEval temp_01_0012 = run(layer == null ? null : layer, true,
        Tensor.addRefs(tensor));
    if (null != tensor)
  ...
  public static SimpleEval run(@Nonnull final Layer layer, boolean validateDerivative, final Tensor... tensor) {
    SimpleEval temp_01_0015 = new SimpleEval(layer == null ? null : layer,
        Tensor.addRefs(tensor));
  ...
  public SimpleEval call() {
    ...
    {
      Tensor[] temp_01_0005 = RefArrays
          .stream(Tensor.addRefs(inputCopy)).map(input -> {
  ...
  public void _free() {
    ...
    synchronized (this) {
      if (null != output) {
        {
          Tensor temp_01_0008 = null;
          if (null != output)
            output.freeRef();
          output = temp_01_0008 == null ? null : temp_01_0008.addRef();
